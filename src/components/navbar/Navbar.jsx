    ...
    return (
        <div className="navbar bg-white fixed z-20 flex justify-between">
            <div className="">
                ...
                <div className="flex items-center gap-1 md:gap-6 lg:gap-10"><Link to='/'><a className="text-2xl md:text-[28px] font-bold text-[#7f1734] flex items-center gap-1"><h1>Dreamscape</h1><SiDreamstime></SiDreamstime></a></Link> <label className="swap swap-rotate mr-4">
