            ...
            <div className="flex justify-between p-4">
                <div className="flex space-x-4">
                    <div>
                        ...
                        <span className="text-xs dark:text-gray-600 font-medium">{email}</span>
                    </div>
                </div>
                <div className="flex items-center space-x-2 dark:text-yellow-700">
                    <svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-4 h-4 fill-current text-yellow-500">
